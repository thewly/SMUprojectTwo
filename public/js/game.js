...
function moveCards(winner) {
  if (winner == "player") {
    ...
    $(".playerCard img").css('position', 'relative').animateCss("fadeOutLeft");
    $(".compCard img").css('position', 'relative').animateCss("fadeOutLeft");
  }
  else if (winner == "comp") {
    console.log("moving right");
    $(".playerCard img").css('position', 'relative').animateCss("fadeOutRight");
    $(".compCard img").css('position', 'relative').animateCss("fadeOutRight");
  }
  else if (winner == "playerWar") {
    $("#warArea img").css("position", "relative").animateCss({ left: '-2000px' }, function() { $("#warArea img").hide(); });
  }
...
function warToArray() {
  ...
  $(".playerWarFinal").html("<img src='/img/"+playerHand[0]+".png'>").animateCss("flipInX");
  $(".playerWarCards").html(cardStr);
  $(".compWarCards").html(cardStr);
  $(".compWarFinal").html("<img src='/img/"+compHand[0]+".png'>").animateCss("flipInY");
